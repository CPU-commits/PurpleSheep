<template>
	<footer class="Footer">
		<div class="Footer__text-logo">
			<img src="/logos/logo-white.svg" alt="Logo" />
			<h2>PurpleSheep...</h2>
		</div>
		<NuxtLink to="https://github.com/CPU-commits/PurpleSheep">
			<h4>Repositorio</h4>
		</NuxtLink>

		<aside class="Footer__SocialNetworks">
			<NuxtLink
				class="Footer__SocialNetworks--SocialNetwork"
				to="https://www.instagram.com/purple.sheep.web"
				rel="external"
				target="_blank"
			>
				<svg
...
.Footer__SocialNetworks--SocialNetwork {
	display: flex;
	align-items: center;
	gap: 5px;
	span {
